...
'''
same idea as war.py but different ordering 
of putting cards back in the deck - p0 always on top of p1
'''
...
def main():
    ...
    print(tie_counter, "out of", game_counter, "games end in ties. There are", cycle_counter, "cycles.")
